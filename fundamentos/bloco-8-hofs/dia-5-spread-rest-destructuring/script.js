...
const filterPeople = () => {
 const result = people.filter(({ nationality, bornIn}) => nationality === 'Australian' && bornIn > 1900 && bornIn < 2001)
 return result;
};
...
const carList = ([name, brand, year]) => ({ name, brand, year});
console.log(carList(palio))
